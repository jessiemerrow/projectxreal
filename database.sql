...
--
-- Host: 127.0.0.1
-- Creato il: Apr 13, 2021 alle 11:28
...
(1, 'General', 'The general category for the collection of all kinds of stories.', 'general', '1', 0, '2021-02-06 08:09:05', '2021-04-13 06:03:08');
...
--
ALTER TABLE `photos`
  ADD CONSTRAINT `photos_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `items` (`id`) ON DELETE CASCADE;
